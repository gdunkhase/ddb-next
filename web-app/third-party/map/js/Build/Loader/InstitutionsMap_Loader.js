...
GeoTemCoLoader = {
	...
	load : function() {
		...
		GeoTemCoLoader.urlPrefix = GeoTemCoLoader.resolveUrlPrefix('js/Build/Loader/InstitutionsMap_Loader.js');
...
//			url : GeoTemCoLoader.urlPrefix + 'js/Table/' + 'Table.js',
			...
			url : GeoTemCoLoader.urlPrefix + 'InstitutionsMapModel.js',
		}, {
			url : GeoTemCoLoader.urlPrefix + 'InstitutionsMapController.js',
		}];
