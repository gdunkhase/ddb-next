...
GeoTemCoLoader = {
	...
	load : function() {
		...
		GeoTemCoLoader.urlPrefix = GeoTemCoLoader.resolveUrlPrefix('js/Build/Loader/InstitutionItemMap_Loader.js');
...
//		}]);
		...
		var geoTemCoFiles = [{
			url : GeoTemCoLoader.urlPrefix + 'js/Util/' + 'GeoPublisher.js'
		}, {
...
//			url : GeoTemCoLoader.urlPrefix + 'js/Table/' + 'Table.js',
			...
			url : GeoTemCoLoader.urlPrefix + 'InstitutionItemMapModel.js',
		}, {
			url : GeoTemCoLoader.urlPrefix + 'InstitutionItemMapController.js',
		}];
