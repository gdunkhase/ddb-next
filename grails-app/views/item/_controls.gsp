...
<div class="controls">
  <div class="buttons">
    <a class="back tools" href="#" title="Back to the results list"><span>Back
        to the results list</span></a> <a class="link tools" href="${itemUri}"
