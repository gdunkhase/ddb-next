<div class="row-fluid search-group">
  <div class="span12">
    <div class="row-fluid">
      ...
      <div class="span1 button-group">
        <button type="button" class="remove-group-button" style="display:none" title="<g:message code="ddbnext.AdvancedSearch_RemoveGroupButton_Title"/>"></button>
      </div>
    </div>

    <div class="row-fluid">
      <div class="span12 hr white"></div>
    </div>
    <div class="row-fluid">
      <div class="span12 search-field-group">
        <g:set var="row" value="${0}"/>
        <g:while test="${row < searchFieldCount}">
          <div class="row-fluid search-field-row">
