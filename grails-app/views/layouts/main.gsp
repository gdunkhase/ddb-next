...
<html>
  ...
  <script src="${resource(dir: 'js', file: 'rx.js')}"></script>
  <script src="${resource(dir: 'js', file: 'rx.jQuery.js')}" /></script>
  ...
  <script src="${resource(dir: 'js', file: 'dateformat.min.js')}"></script>
  <script src="${resource(dir: 'js', file: 'knockout-latest.js')}"></script>
  <script src="${resource(dir: 'js', file: 'knockout.mapping-latest.js')}"></script>
  <script src="${resource(dir: 'js', file: 'jquery.mousewheel.min.js')}"></script>
  <script src="${resource(dir: 'js', file: 'jquery.microdata.js')}"></script>
  ...
  <script src="${resource(dir: 'js', file: 'ddb.min.js')}"></script>
  ...
  <!-- TODO: do we use this script? if yes, then move to an external file. Otherwise: remove it -->
  <script>
      var global;
      var resources;
